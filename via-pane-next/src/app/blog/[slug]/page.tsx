        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#F9F7F2]">
                <div className="text-center">
                    ...
                    <Link href="/blog" className="text-[#D4AF37] hover:underline font-semibold">
                        Voltar para o Blog
                    </Link>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-[#F9F7F2]">
            ...
            <article className="max-w-4xl mx-auto px-6 py-12">
                ...
                <header className="mb-12 text-center">
                    <div className="inline-block bg-[#D4AF37] text-white px-4 py-1 rounded-full text-sm font-semibold mb-6">
                        {categoryName}
                    </div>
