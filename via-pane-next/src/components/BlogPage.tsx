                    ...
                    <div className="max-w-2xl mx-auto">
                        <div className="relative">
                            <input
                                ...
                                className="w-full pl-6 pr-14 py-4 rounded-lg border-2 border-[#D3AF37] bg-white text-[#001A33] font-['Open_Sans'] text-base focus:outline-none focus:ring-2 focus:ring-[#D3AF37]"
                            />
                            <button className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-[#D3AF37] hover:bg-[#B89A2E] text-white p-2 rounded-lg transition-colors">
                                <Search size={20} />
                            </button>
                        </div>
                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="relative h-56 overflow-hidden">
                                            ...
                                            <div className="absolute top-4 left-4">
                                                <span className="bg-[#D3AF37] text-white px-4 py-1 rounded-full text-xs font-['Open_Sans'] font-semibold">
                                                    {post.category}
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        {/* Post Content */}
                                        <div className="p-6">
                                            <h3 className="font-['Playfair_Display'] text-2xl font-bold text-[#001A33] mb-3 group-hover:text-[#D3AF37] transition-colors">
                                                {post.title}
                                            </h3>
