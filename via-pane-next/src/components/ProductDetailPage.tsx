    ...
    <div className="min-h-screen bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            {/* Category Badge */}
            <div className="inline-block bg-[#D3AF37] text-white px-4 py-2 rounded-full font-['Open_Sans'] font-semibold text-sm mb-6">
              {categoryName}
            </div>
                ...
                <ul className="space-y-2 font-['Open_Sans'] text-gray-700">
                  {advantages.map((adv, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <span className="text-[#D3AF37] mt-1">•</span>
                      <span>{adv}</span>
                    </li>
                  ))}
                </ul>
              ...
              {displayImage ? (
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
                  <div className="text-center p-4">
                    <div className="w-20 h-20 mx-auto mb-3 rounded-full bg-[#D3AF37] bg-opacity-10 flex items-center justify-center">
                      <svg className="w-10 h-10 text-[#D3AF37]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <ol className="space-y-4 font-['Open_Sans'] text-gray-700 leading-relaxed">
                {preparation.map((step, idx) => (
                  <li key={idx} className="flex gap-4">
                    <span className="font-bold text-[#D3AF37] flex-shrink-0">{idx + 1}.</span>
                    <span>{step}</span>
                  </li>
                ))}
              </ol>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="px-6 py-6">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-[#D3AF37]">
      ...
      <div className="bg-gradient-to-br from-[#001A33] to-[#002a52] text-white py-16 mt-12">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Link
            href="/contato"
            className="inline-block bg-[#D3AF37] hover:bg-[#B89A2E] text-white px-10 py-4 rounded-xl font-['Open_Sans'] font-semibold text-lg transition-all duration-300 hover:shadow-xl"
          >
            Fale com nosso time
          </Link>
        </div>
