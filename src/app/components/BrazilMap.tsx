  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative w-full max-w-[400px] h-full">
        <img 
          src="https://upload.wikimedia.org/wikipedia/commons/1/10/Brazil_Blank_Map.svg" 
          alt="Mapa do Brasil"
        ...
        <div className="absolute inset-0">
          ...
          >
            <div className="relative flex items-center justify-center">
              <div
                className={`w-4 h-4 rounded-full transition-all ${
                  activeRegion === 'paraiba' ? 'bg-[#D4AF37] scale-125' : 'bg-[#001A33] hover:scale-110'
                }`}
              />
            ...
            <span
              className={`absolute left-6 top-1/2 -translate-y-1/2 whitespace-nowrap text-sm font-['Open_Sans'] font-semibold transition-colors ${
                activeRegion === 'paraiba' ? 'text-[#D4AF37]' : 'text-[#001A33]'
              }`}
            >
              João Pessoa
            </span>
          ...
          >
            <div className="relative flex items-center justify-center">
              <div
                className={`w-4 h-4 rounded-full transition-all ${
                  activeRegion === 'recife' ? 'bg-[#D4AF37] scale-125' : 'bg-[#001A33] hover:scale-110'
                }`}
              />
              {activeRegion === 'recife' && (
                <div className="absolute w-8 h-8 rounded-full bg-[#D4AF37] opacity-30 animate-ping" />
            ...
            <span
              className={`absolute left-6 top-1/2 -translate-y-1/2 whitespace-nowrap text-sm font-['Open_Sans'] font-semibold transition-colors ${
                activeRegion === 'recife' ? 'text-[#D4AF37]' : 'text-[#001A33]'
              }`}
            >
              Recife
            </span>
          ...
          >
            <div className="relative flex items-center justify-center">
              <div
                className={`w-5 h-5 rounded-full transition-all ${
                  activeRegion === 'sp' ? 'bg-[#D4AF37] scale-125' : 'bg-[#001A33] hover:scale-110'
                }`}
              />
              {activeRegion === 'sp' && (
            ...
            <span
              className={`absolute left-7 top-1/2 -translate-y-1/2 whitespace-nowrap text-sm font-['Open_Sans'] font-semibold transition-colors ${
                activeRegion === 'sp' ? 'text-[#D4AF37]' : 'text-[#001A33]'
              }`}
            >
              São Paulo
            </span>
