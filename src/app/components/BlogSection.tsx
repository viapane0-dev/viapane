...
function BlogCard({ image, category, title, author, date }: BlogCardProps) {
  return (
    <article className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 cursor-pointer">
...
export function BlogSection() {
  const posts = [
    {
      image: "https://images.unsplash.com/photo-1630329777937-e0de732a893c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicmVhZCUyMG1ha2luZyUyMGJha2VyeXxlbnwxfHx8fDE3Njg2OTQwMDl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    {
      image: "https://images.unsplash.com/photo-1611588275568-72ecc1a502d1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiYWtlciUyMHdvcmtpbmclMjBkb3VnaHxlbnwxfHx8fDE3Njg2ODgzNjF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      category: "Tendências",
