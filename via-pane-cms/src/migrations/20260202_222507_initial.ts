...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "products_technical_info" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "products_nutritional_table" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"nutrient" varchar NOT NULL,
  ...
  CREATE TABLE "home_hero_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type" "enum_home_hero_banner_type" DEFAULT 'dynamic' NOT NULL,
  	"title" varchar,
  	"button_text" varchar,
  	"button_url" varchar,
  	"image_id" integer NOT NULL
  ...
  ALTER TABLE "products_technical_info" ADD CONSTRAINT "products_technical_info_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_nutritional_table" ADD CONSTRAINT "products_nutritional_table_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_hero_banner" ADD CONSTRAINT "home_hero_banner_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "home_hero_banner" ADD CONSTRAINT "home_hero_banner_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "products_technical_info_order_idx" ON "products_technical_info" USING btree ("_order");
  CREATE INDEX "products_technical_info_parent_id_idx" ON "products_technical_info" USING btree ("_parent_id");
  CREATE INDEX "products_nutritional_table_order_idx" ON "products_nutritional_table" USING btree ("_order");
  CREATE INDEX "products_nutritional_table_parent_id_idx" ON "products_nutritional_table" USING btree ("_parent_id");
  ...
  CREATE INDEX "home_hero_banner_order_idx" ON "home_hero_banner" USING btree ("_order");
  CREATE INDEX "home_hero_banner_parent_id_idx" ON "home_hero_banner" USING btree ("_parent_id");
  CREATE INDEX "home_hero_banner_image_idx" ON "home_hero_banner" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "products_technical_info" CASCADE;
  DROP TABLE "products_nutritional_table" CASCADE;
